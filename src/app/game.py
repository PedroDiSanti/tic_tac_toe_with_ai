class Game:
    ...
    def check_win(self, player: str):
        ...
        """
        win_conditions = [
            [self.render_board.board[0][j] == player and self.render_board.board[1][j] == player and self.render_board.board[2][j] == player for j in range(3)],  # columns
            [self.render_board.board[i][0] == player and self.render_board.board[i][1] == player and self.render_board.board[i][2] == player for i in range(3)],  # rows
            [self.render_board.board[0][0] == player and self.render_board.board[1][1] == player and self.render_board.board[2][2] == player],  # main diag
            [self.render_board.board[0][2] == player and self.render_board.board[1][1] == player and self.render_board.board[2][0] == player]  # second diag
        ]
